...
object IPApp {
  ...
  val IMAGE_CATEGORIES = List("duck", "hen", "parrot", "sparrow")
  ...
  def generateRandomForestModel(sc: SparkContext): Unit = {
    ...
    val randomForestModel = DecisionTree.trainClassifier(parsedData, numClasses, categoricalFeaturesInfo, bestimpurity, bestmaxdepth, maxBins)
